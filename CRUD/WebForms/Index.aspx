    ...
    <div class="container">
        <form id="form1" runat="server">
            ...
            <div class="row mb-3">
                <div class="col-3">
                    <div class="form-group">
                        <label for="TxtDataNascimento" class="form-label required">Data Nascimento</label>
            ...
            <div class="row mb-3">
                <div class="col">
                    <asp:GridView ID="GrdClientes" runat="server" AutoGenerateColumns="False" class="table table-stripped table-hover" HeaderStyle-HorizontalAlign="Center" HeaderStyle-VerticalAlign="Middle" RowStyle-VerticalAlign="Middle" OnRowCommand="GrdClientes_RowCommand" OnRowDataBound="GrdClientes_RowDataBound">
                        <Columns>
                            <asp:TemplateField>
                                <ItemTemplate>
                                    <asp:LinkButton ID="BtnVisualizar" runat="server" CommandName="Visualizar" title="Visualizar" class="btn btn-outline-secondary"><span class="bi-list"></span></asp:LinkButton>
                                </ItemTemplate>
                            </asp:TemplateField>
                            ...
                            <asp:TemplateField>
                                <ItemTemplate>
                                    <asp:LinkButton ID="BtnEditar" runat="server" CommandName="Editar" title="Editar" class="btn btn-outline-primary"><span class="bi-pencil"></span></asp:LinkButton>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField>
                                <ItemTemplate>
                                    <asp:LinkButton ID="BtnExcluir" runat="server" CommandName="Excluir" title="Excluir" class="btn btn-outline-danger"><span class="bi-trash"></span></asp:LinkButton>
                                </ItemTemplate>
                            </asp:TemplateField>
                        </Columns>
                    </asp:GridView>
